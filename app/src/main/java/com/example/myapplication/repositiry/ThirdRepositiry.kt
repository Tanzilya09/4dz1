...
class ThirdRepositiry {
    ...
    private var thirdModelList = mutableListOf<FirstModel>()

    fun getListOfText(): MutableList<FirstModel> {


        thirdModelList.add(FirstModel("https://api.time.com/wp-content/uploads/2014/07/301386_full1.jpg",
            "Harry Potter")
        )

        thirdModelList.add(FirstModel(
